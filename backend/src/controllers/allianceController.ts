...
// @access  Public
export const getAlliances = async (req: express.Request, res: express.Response) => {
    try {
...
// @access  Private
export const createAlliance = async (req: express.Request, res: express.Response) => {
...
// @access  Private
export const joinAlliance = async (req: express.Request, res: express.Response) => {
    const user = req.user;
...
// @access  Private
export const leaveAlliance = async (req: express.Request, res: express.Response) => {
    const user = req.user;
    const allianceId = new ObjectId(req.params.id);
